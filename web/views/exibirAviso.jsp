...
<html>
    <head>
        <%
           ...
           List<Aviso> listaExibirAviso = new AvisoDAO().PesquisarAviso(request.getParameter("token"));
                    ...
                    <div>
                        ...
                        <div class="box">
                            <div class="box-header">
                                <h2>
                                    <span class="fa fa-thumb-tack"></span><span class="glyphicon-class"> Aviso </span></h2>
                            </div>
                            <div class="callout callout-info">
                                <p>
                                    Avisos do seu condomínio.</p>
                            </div>
                                ...
                                <div class="box box-info">
                                    ...
                                    <!-- form start -->
                                        ...
                                        <div class="box-body form-horizontal">
                                            ...
                                            <%
                                                            if (listaExibirAviso.size() == 0) {
                                                        %>
                                                    <p>Sem dados de aviso</p>
                                                    <%
                                                    } else {

                                                        for (Aviso aviso : listaExibirAviso) {
                                                    %>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" disabled="disabled" value="<%=aviso.getTitulo()%>"  style="background-color: white"name="titulomsg">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="emailMorador" class="col-sm-2 control-label">Data:</label>
                                                <div class="col-sm-10">
                                                    <input type="email" class="form-control" id="emailMorador" name="emailMorador" disabled="disabled" style="background-color: white" value="<%=aviso.getData()%> ">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="senhaMorador" class="col-sm-2 control-label">Mensagem:</label>
                                                <div class="col-sm-10">
                                                    <textarea type="text" class="form-control" rows="10" id="senhaMorador" name="senhaMorador" disabled="disabled" style="background-color: white" ><%=aviso.getMensagemAviso()%></textarea>
                                                </div>
                                            </div>
                                           
                                            <div class="box-footer">
                                                
                                                    <a href="<%=contextPath%>/views/aviso.jsp">
                                                       Voltar</a>
