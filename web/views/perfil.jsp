            ...
            <p>
                ...
                <div class="box-body">
                    <div class="box-body box-profile">
                        <img id="ContentPlaceHolder1_logo" class="profile-user-img img-responsive img-circle" src="dist/img/user9.jpg">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                <label for="exampleInputEmail1">
                                    Nome:</label>
                                <input name="ctl00$ContentPlaceHolder1$txtNome" type="text" value="Rangel Paolo" id="ContentPlaceHolder1_txtNome" class="form-control">
                                <label for="exampleInputEmail1">
                                    Email:</label>
