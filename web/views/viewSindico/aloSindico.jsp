            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <div class="box-header">
                        <h2><span class="ion ion-android-call"></span><span class="glyphicon-class"> Controle de Mensagens - Alô Sindico</span></h2>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <!-- Menu Filtro-->
                        <div class="box box-solid" style="min-height: 180px;">
                            <div class="box-header with-border">
                                <h3 class="box-title">
                                    Filtro</h3>
                                <div class="box-tools">
